...
use Nalzai35\FilamentCurrency\Manager\ExchangeRateManager;
use Spatie\LaravelPackageTools\Commands\InstallCommand;
use Spatie\LaravelPackageTools\Package;
use Spatie\LaravelPackageTools\PackageServiceProvider;
use Nalzai35\FilamentCurrency\Commands\FilamentCurrencyCommand;
use Nalzai35\FilamentCurrency\Testing\TestsFilamentCurrency;
...
class FilamentCurrencyServiceProvider extends PackageServiceProvider
{
        ...
        $package->name(static::$name)
            ...
            ->hasInstallCommand(function (InstallCommand $command) {
                $command
                    ...
                    ->publishMigrations()
                    ->askToRunMigrations()
                    ->askToStarRepoOnGitHub('nalzai35/filament-currency');
            });
    ...
    public function packageRegistered(): void
    {
        $this->app->singleton('exchange-rate', function ($app) {
            return $app->make(ExchangeRateManager::class);
        });
    }
    ...
    {
        return 'nalzai35/filament-currency';
    }
...
//            Js::make('filament-currency-scripts', __DIR__ . '/../resources/dist/filament-currency.js'),
    ...
    {
        return [
            'create_filament_currency_table',
        ];
    }
}
